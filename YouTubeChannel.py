...
key = 'AIzaSyDvLvhGHV2SKwLMY3Y3saDN4YRGgDa_JKs'
...
#orange =UCSTBpjukawEv6ZUmH6l-ibw
# zain= =UCc4ucYAsnKOXypwTXoo3PSg
#umniah =UCPPZ8FnXyhvUy2RWrjPcjcg
...
def channelAnalyzer(channels, numberOfVideos):
    ...
    for id in channels:
        ...
        for i in range  (len(channelSearch)):
            videoMetadata = yt.get_video_metadata(video_id=channelSearch[i]["video_id"])
...
def faceRecogonitionInThumbnail(thumbnailUrl):
    ...
    cascPath = r"C:\Users\mtantawi\Anaconda3\Lib\site-packages\cv2\data\haarcascade_frontalface_default.xml"
